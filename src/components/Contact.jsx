...
const socialLinks = [
    ...
    {
        href: 'https://www.instagram.com/samukajj',
    ...
    return (
        <section className="section reveal-up" id="contact">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch reveal-up">
                    ...
                    <div className="flex items-center gap-2 mt-auto reveal-up">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a
                                ...
                                href={href}
                                target="_blank"
                                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-sm transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 text-zinc-50/50 active:bg-zinc-50/80 reveal-up"
                            >
                                {icon}
                            </a>
                        ))}
                ...
                <form 
                    action="https://getform.io/f/azyyxmeb"
                    method="POST"
                ...
                >
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input 
                                ...
                                autoComplete="email"
                                required 
                                placeholder="Ex.: samuka@example.com"
                                className="text-field reveal-up" 
                            />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea 
                            name="message" 
                            id="message"
                            placeholder="Hi! Write a message for me"
                            required
